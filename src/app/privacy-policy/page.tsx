...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Routeway.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Routeway Insurance, accessible from <a href="https://routeway.vercel.app/" rel="external nofollow noopener" target="_blank">https://routeway.vercel.app/</a></p>
</li>
<li>
...
<ul>
<li>By email: Mj@routeway360.com</li>
</ul>`;
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-6">
      <div className="max-w-3xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <button
          onClick={() => router.back()}
          className="bg-[#254184] text-white p-4 rounded-xl mb-6 text-sm text-indigo-600 hover:scale-105 hover:brightness-110 cursor-pointer transition-all duration-200 ease-in-out"
        >
          ← Back
        </button>
